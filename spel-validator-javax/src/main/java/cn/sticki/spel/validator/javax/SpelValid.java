...
/**
 * 标记开启spel约束注解的验证，其功能类似于 {@link javax.validation.Valid}，用于开启 {@link cn.sticki.spel.validator.core.constrain} 包下定义的spel约束。
 * <p>
 * 注意：该注解需要配合 {@link javax.validation.Valid} 或 {@link org.springframework.validation.annotation.Validated} 注解一起使用。
 * <p>
