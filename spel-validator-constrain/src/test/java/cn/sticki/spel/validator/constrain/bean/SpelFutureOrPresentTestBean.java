...
/**
 * {@link SpelFutureOrPresent} 测试用例
 *
 * @author 阿杆
 * @version 1.0
 * @since 2024/12/21
 */
public class SpelFutureOrPresentTestBean {
    ...
    public static class ParamTestBean implements ID {
        ...
        @SpelFutureOrPresent(condition = "#this.condition")
    ...
    public static List<VerifyObject> paramTestCase() {
        ...
        result.add(VerifyObject.of(
                ParamTestBean.builder()
                        .id(1)
                        .condition(true)
                        .futureOrPresentDate(LocalDate.now().plusDays(1))
        ...
        result.add(VerifyObject.of(
                ParamTestBean.builder()
                        .id(2)
                        .condition(true)
                        .futureOrPresentDate(LocalDate.now().minusDays(1))
                        .conditionalDateTime(LocalDateTime.now().minusHours(1))
                        .utilDate(new Date(System.currentTimeMillis() - 3600000))
                        .build(),
                VerifyFailedField.of(ParamTestBean::getFutureOrPresentDate),
    ...
    static class RepeatableTestBean {
        ...
        @SpelFutureOrPresent(condition = "#this.condition1", message = "condition1")
        @SpelFutureOrPresent(condition = "#this.condition2", message = "condition2")
