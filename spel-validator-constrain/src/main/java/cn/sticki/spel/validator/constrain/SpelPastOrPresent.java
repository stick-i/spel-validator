...
import cn.sticki.spel.validator.constraintvalidator.SpelPastOrPresentValidator;
...
public @interface SpelPastOrPresent {
     ...
     * 校验失败时的错误消息
     */
    String message() default "{cn.sticki.spel.validator.constraint.PastOrPresent.message}";
