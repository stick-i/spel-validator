...
public class SpelParser {
	 ...
	 */
	public static <T> T parse(String expression, Object rootObject, Class<T> desiredResultType) {
		...
		if (!desiredResultType.isInstance(any)) {
			throw new SpelParserException("Expression [" + expression + "] calculate result must be [" + desiredResultType.getName() + "]");
		}
		return desiredResultType.cast(any);
	}
