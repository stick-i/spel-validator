...
public class SpelPastTestBean {
    ...
    public static class ParamTestBean implements ID {
        ...
        @SpelPast(condition = "#this.condition")
    ...
    public static List<VerifyObject> paramTestCase() {
        ...
        result.add(VerifyObject.of(
                ParamTestBean.builder()
                        .id(2)
                        .condition(true)
                        .pastDate(LocalDate.now().plusDays(1))
                        .conditionalDateTime(LocalDateTime.now().plusHours(1))
                        .utilDate(new Date(System.currentTimeMillis() + 3600000))
                        .build(),
                VerifyFailedField.of(ParamTestBean::getPastDate),
    ...
    static class RepeatableTestBean {
        ...
        @SpelPast(condition = "#this.condition1", message = "condition1")
        @SpelPast(condition = "#this.condition2", message = "condition2")
